...
package com.up72.library.picture.crop;
...
class CropUtil {
    ...
    static void closeSilently(@Nullable Closeable c) {
        if (c == null) return;
        try {
            c.close();
        } catch (Throwable t) {
    ...
    static int getExifRotation(File imageFile) {
    ...
    static boolean copyExifRotation(File sourceFile, File destFile) {
    ...
    @Nullable
    static File getFromMediaUri(Context context, ContentResolver resolver, Uri uri) {
