...
public class SwitchButton extends CompoundButton {
    ...
    public void setDrawableResIds(int frameDrawableResId, int stateDrawableResId, int stateMaskDrawableResId, int sliderDrawableResId) {
        if (getResources() != null) {
            setDrawables(
                    ContextCompat.getDrawable(getContext(), frameDrawableResId),
                    ContextCompat.getDrawable(getContext(), stateDrawableResId),
                    ContextCompat.getDrawable(getContext(), stateMaskDrawableResId),
                    ContextCompat.getDrawable(getContext(), sliderDrawableResId)
            );
        }
    }
